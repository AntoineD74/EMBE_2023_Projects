...
MODULE_DESCRIPTION("Simple test measuring the time elasped between detection rising edge and resulting action"); 
MODULE_VERSION("0.1");

static unsigned int gpioLED = 18;             // pin 18 (GPIO17) 
static unsigned int gpioButton = 17;          // pin 17 (GPIO27) 
...
{   
    ...
    printk(KERN_INFO "The action is done, interrupt ending !");
